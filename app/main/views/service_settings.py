...
def service_switch_live(service_id):
    ...
    if form.validate_on_submit():
        ...
        sms_daily_limit = current_app.config["DEFAULT_SERVICE_SMS_LIMIT"]
        if live:
            ...
            if current_service.sms_daily_limit != current_app.config["DEFAULT_SERVICE_SMS_LIMIT"]:
                sms_daily_limit = current_service.message_limit
            else:
                sms_daily_limit = current_app.config["DEFAULT_LIVE_SERVICE_SMS_LIMIT"]
